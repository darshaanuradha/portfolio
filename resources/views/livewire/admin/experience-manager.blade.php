            ...
            <div class="grid lg:grid-cols-2 gap-8">
                    ...
                    <form wire:submit.prevent="save" class="space-y-6">
                        <div class="grid md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="title" wire:model="title" placeholder="e.g., Lead Developer" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        ...
                        <div>
                            ...
                            <input type="text" id="company" wire:model="company" placeholder="e.g., National Pest Surveillance System (NPSS)" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            @error('company') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>

                        <div>
                            <label for="description" class="block text-sm font-medium text-gray-700 mb-2">Description (Optional)</label>
                            <textarea id="description" wire:model="description" rows="4" placeholder="Describe your role, responsibilities, and achievements..." class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"></textarea>
                ...
                <div class="bg-white rounded-lg shadow">
                    <div class="p-6 border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-gray-900">Experience List</h3>
                    </div>
                    <div class="divide-y divide-gray-200">
                        ...
                        <div class="p-6">
                            <div class="flex justify-between items-start">
                                <div class="flex-1">
                                    <h4 class="text-lg font-semibold text-blue-600">{{ $experience->title }}</h4>
                                ...
                                <div class="flex space-x-2 ml-4">
                                    <button wire:click="edit({{ $experience->id }})" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                        Edit
                                    </button>
                                    <button wire:click="delete({{ $experience->id }})" onclick="return confirm('Are you sure you want to delete this experience?')" class="text-red-600 hover:text-red-800 text-sm font-medium">
                                        Delete
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="p-6 text-center text-gray-500">
                            No experience records found. Add your first experience record above.
                        </div>
                        @endforelse
                    </div>
                </div>
